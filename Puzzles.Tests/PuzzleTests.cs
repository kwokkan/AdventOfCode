namespace AdventOfCode2020.Puzzles.Tests
{
    ...
    public class Puzzle19Tests : TestBase<Puzzle19>
    {
    ...
    public class Puzzle20Tests : TestBase<Puzzle20>
    {
    ...
    public class Puzzle23Tests : TestBase<Puzzle23>
    {
    ...
    public class Puzzle24Tests : TestBase<Puzzle24>
    {
    ...
    public class Puzzle25Tests : TestBase<Puzzle25>
    {
